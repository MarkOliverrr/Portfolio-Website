...
import { 
  ...
  SiExpress, SiPostgresql, SiPython, SiPhp, SiLaravel,
  SiCodeigniter, SiBootstrap, SiMysql, SiGit
} from 'react-icons/si';
import { PiCodeBold } from "react-icons/pi";
import { LuBadge } from "react-icons/lu";
import { LiaLayerGroupSolid } from "react-icons/lia";
import { useNavbar } from '../contexts/NavbarContext';
import FlutterFlowLogo from '../assets/images/flutterflow.png';
...
const dummyProjects = [
    {
    title: "Alyssa Gadgets Point of Sale & Inventory System",
    description: "A Point-of-Sale and Inventory Management system for Alyssa Gadgets, built with PHP, CodeIgniter, Bootstrap, and MySQL.",
  ...
  {
    title: "CLSU Faculty Hiring Evaluation System",
    description: "A faculty hiring evaluation system with RESTful APIs, including authentication, applicant management, and scoring features.",
    tech: ["Laravel", "TailwindCSS", "MySQL", "Git"],
  ...
  },
  {
    ...
    description: "A food delivery web application with order management, payment integration, and real-time tracking features.",
    tech: ["Laravel", "TailwindCSS", "MySQL", "SMTP/API"],
    link: "#",
...
const ProjectCard = ({ project }) => {
    ...
    "Laravel": <SiLaravel />, "PHP": <SiPhp />, "CodeIgniter": <SiCodeigniter />,
    "Bootstrap": <SiBootstrap />, "MySQL": <SiMysql />, "Git": <SiGit />,
    "SMTP/API": "📧", "SQL": <SiMysql />
    };
...
// === CHANGE START: Handler for the Show More/Less button ===
...
{/* === CHANGE: Using slice to display visible certificates === */}
                    <AnimatePresence>
                 ...
                 {/* === CHANGE START: Adding conditional Show More/Less button === */}
