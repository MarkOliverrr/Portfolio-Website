...
const handleDeleteComment = (commentId) => {
  ...
  return (
              ...
              <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-3xl p-8 border border-slate-700/50">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">Is there something you’d like to discuss? Send me a message!</p>
                  </div>
                </div>
    ...
    className="flex items-center gap-2 text-slate-400 hover:text-red-400 transition-colors duration-300 group/delete"
  >
    <FaTrash className="group-hover/delete:scale-110 transition-transform duration-300" />
