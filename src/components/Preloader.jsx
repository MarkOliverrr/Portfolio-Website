    ...
    if (showContent) {
      ...
      if (typedText.length < fullText.length) {
        ...
        const exitTimer = setTimeout(() => {
          setFadeOut(true);
          setTimeout(onFinished, 1000); // fade-out
        }, 1500); 
          ...
          {showContent && (
            ...
            >
              ...
              >
                ...
                <a href="https://www.linkedin.com/in/mark-oliver-gurtiza-30a558218/" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <Linkedin size={32} />
                </a>
                <a href="https://www.instagram.com/_mrkolvr/" target="_blank" rel="noopener noreferrer" className="hover:text-[#00ffdc] transition-all duration-300 transform hover:scale-110">
                  <Instagram size={32} />
                </a>
              </motion.div>
            </motion.div>
