            ...
            <section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
              ...
              <div className="flex-1 text-white space-y-6 pt-16 md:pt-40 order-last md:order-none">
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 1.0, ease: "easeOut" }} className="flex flex-row gap-4 mt-8">
                    <a href="https://github.com/MarkOliverrr" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
                        <FaGithub className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-cyan-300" />
                    </a>
                    <a href="https://www.instagram.com/tortang.tolonggiiis/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
                        <FaInstagram className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-cyan-300" />
                    </a>
                    <a href="https://www.linkedin.com/in/markoliver-gurtiza" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                >
                  ...
                  <h3 className="text-4xl font-bold text-white my-2 font-moderniz" style={{ textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc" }}>Mark Oliver </h3>
                  <p className="text-white/80 leading-relaxed mt-4 font-cascadia text-justify">
I am a Bachelor of Science in Information Technology graduate at Central Luzon State University, with a strong interest in Front-End development and modern web technologies. I am passionate about continuous learning and driven to create innovative digital solutions that combine functionality with great user experience.                  </p>
                  ...
                  <div className="flex flex-row sm:flex-row gap-4 mt-8 justify-center md:justify-start items-center">
                    <ButtonMovingBorder as="a" href="/certificates/oli cv.pdf" download duration={3000} borderRadius="0.75rem" className="bg-slate-900/[0.8] border border-slate-800 text-white font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-[0_0_24px_8px_#40ffaa]">
            ...
            <footer className="py-8 text-center text-gray-400">
              <div className="text-sm">© {new Date().getFullYear()} Mark Oliver Gurtiza. All rights reserved.</div>
